<#
.SYNOPSIS
    Completely uninstalls the consumer build of KalOS.

.DESCRIPTION
    Safely terminates any running instances of KalOS and its hardware 
    monitoring worker, deletes the installation directory, and removes 
    Start Menu and Desktop shortcuts.

.EXAMPLE
    .\uninstall-kalos.ps1
    .\uninstall-kalos.ps1 -InstallDir "C:\Custom\KalOS"
    .\uninstall-kalos.ps1 -Silent
...
Write-Step "Checking for running instances of KalOS..."
$processes = @("KalOS", "HardwareMonitorWorker")
...
$startMenu = Join-Path $env:APPDATA "Microsoft\Windows\Start Menu\Programs\KalOS.lnk"
...
Write-OutputMsg "KalOS has been successfully removed from this system." "Green"
